...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        ...
        <hr class="my-4">
        <img src="../img/gettyimages-175925832_1615921990607.jpeg" width="100%" height="600px" style="opacity: 0.3;">
    </div>
        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 25rem;">
                    <img src="../img/gettyimages-175925832_1615921990607.jpeg" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card" style="width: 25rem;">
                    <img src="../img/vete-11.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-primary">Go somewhere</a>
            ...
            <div class="col">
                <div class="card" style="width: 25rem;">
                    <img src="../img/animales-domesticos.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-primary">Go somewhere</a>
    ...
    <footer class="text-center text-lg-start text-muted" style="background-color: #D6EAF8 !important;">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        ...
                        <h6 class="text-uppercase fw-bold mb-4">
                            <i class="fas fa-gem me-3"></i>Nombre de la Compañía
                        </h6>
                        <p>
                            Aquí puedes usar filas y columnas para organizar el contenido del pie de página. Lorem ipsum
                    ...
                    <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <p>
                            <a href="#!" class="text-white">Precio</a>
                        </p>
                        <p>
        ...
        <div class="text-center text-white p-4" style="background-color: rgba(0, 0, 0, 0.05);">
            © <?php echo date("Y"); ?> Derechos reservados por <a class="text-reset fw-bold" href="https://mdbootstrap.com/">MDBootstrap.com</a>
        </div>
        <!-- Copyright -->
    </footer>
